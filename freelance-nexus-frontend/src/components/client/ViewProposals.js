...
<strong>Bid Amount:</strong> ₹{proposal.proposedBudget}
</div>
<div className="col-sm-6">
...
>
                          ...
                          {/* FIXED: Safe fallback for freelancerId */}
<Link
                            to={`/freelancer/profile/${proposal.freelancerId || proposal.freelancer?.id}`}
