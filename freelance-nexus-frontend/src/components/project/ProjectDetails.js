          ...
          <div className="card shadow-sm mb-4">
            ...
            <div className="card-body">
              <div className="mb-3">
                ...
                <div className="mt-1">₹{project.budgetMin} - ₹{project.budgetMax}</div>
              </div>
              ...
              {authenticated && user.role === "FREELANCER" && project.status === 'OPEN' && (
              ...
              {authenticated && user.role === "CLIENT" && user?.id === project.clientId && (
<div className="d-grid gap-2 mt-4">
...
<span className="ai-badge">AI</span> Rank Proposals
    ...
    {project.status === "COMPLETED" && project.assignedFreelancer && (
<Link 

        to={`/rate-freelancer/${project.assignedFreelancer}?projectId=${project.id}`}
