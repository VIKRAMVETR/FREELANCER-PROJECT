...
import RateFreelancer from './components/rating/RateFreelancer';
      ...
      <Router>
        <div className="d-flex flex-column min-vh-100">
          ...
          <main className="flex-grow-1">
            ...
            <Route path="/rate-freelancer/:freelancerId" element={
            ...
            <RateFreelancer />
              ...
              <Route path="/payment/:paymentId/receipt" element={<PaymentReceipt />} />
            </Routes>
          </main>
          <Footer />
        </div>
