...
public class UPIPaymentService {
    ...
    public UPIPaymentDTO generateUPIPaymentLink(String transactionId, BigDecimal amount, String upiId, String currency) {
        ...
        UPIPaymentDTO upiPayment = new UPIPaymentDTO(transactionId,upiId,amount, currency,paymentLink,
    			qrCode,900L,"INITIATED","UPI payment link generated successfully");
