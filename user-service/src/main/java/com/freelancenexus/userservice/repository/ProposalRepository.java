...
public interface ProposalRepository extends JpaRepository<Proposal, Long> {
    ...
    @Query("SELECT p FROM Proposal p WHERE p.project.id = :projectId")
    List<Proposal> findByProjectId(@Param("projectId") Long projectId);
