...
import com.freelancenexus.userservice.config.GeminiConfig;
...
public class GeminiIntegrationService {
    ...
    private final Logger log= LoggerFactory.getLogger(GeminiIntegrationService.class);
    
    public GeminiIntegrationService(WebClient geminiWebClient, GeminiConfig geminiConfig, ObjectMapper objectMapper) {
		super();
