...
public class PaymentService {
	...
	public PaymentService(PaymentRepository paymentRepository,
			...
			RabbitTemplate rabbitTemplate, FreelancerRepository freelancerRepository) {
		super();
