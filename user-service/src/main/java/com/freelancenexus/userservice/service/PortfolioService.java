...
public class PortfolioService {
    ...
    public PortfolioDTO addPortfolio(Long freelancerId, PortfolioDTO portfolioDTO) {
        ...
        portfolio.setFreelancer(freelancer);   // <-- REQUIRED
